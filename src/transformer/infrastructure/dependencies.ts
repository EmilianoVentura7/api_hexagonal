...
export const getAllUseCase = new GetAllTransformerUseCase(
  mysqlTransformerRepository
);
...
export const getByUserTransformerController =
  new GetByUserTransformerController(getByUserTransformerUseCase);
